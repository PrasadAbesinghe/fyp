...
Algorithm~\ref{alg:lw_dp_det} (\texttt{LW-DP-Det}) performs lightweight
rule-based grey hole detection on the data plane. It takes as input the vehicle
...
Algorithm~\ref{alg:fv_det} (\texttt{FV-Det}) implements the full-mode
detection pipeline, engaged when the lightweight rule-based detectors either
do not fire or produce uncertain results. It takes as input the vehicle
